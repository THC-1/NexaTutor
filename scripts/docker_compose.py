...
def render_docker_env(
    ...
    values = {
        "NEXATUTOR_DOCKER_BACKEND_PORT": str(
            _coerce_port(system.get("backend_port"), DEFAULT_BACKEND_PORT)
        ),
        "NEXATUTOR_DOCKER_FRONTEND_PORT": str(
    ...
    lines = [
        ...
        "# Do not edit manually; update system.json instead.",
    ]
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "Docker settings: "
        f"backend={values['NEXATUTOR_DOCKER_BACKEND_PORT']} "
        f"frontend={values['NEXATUTOR_DOCKER_FRONTEND_PORT']}",
        file=sys.stderr,
    )
