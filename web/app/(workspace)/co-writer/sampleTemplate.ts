...
export const CO_WRITER_SAMPLE_TEMPLATE = `# NexaTutor Co-Writer

> NexaTutor's built-in writing canvas for notes, reports, tutorials, and AI-assisted drafts.
...
- A practical starter draft for NexaTutor product docs and learning content

## Headers (Underline)

NexaTutor Learning Note
=============

NexaTutor Study Outline
-------------
...
The <abbr title="Large Language Model">LLM</abbr> layer powers NexaTutor while the <abbr title="Retrieval Augmented Generation">RAG</abbr> layer provides grounded knowledge support.

### Blockquotes

> NexaTutor helps students turn questions into structured understanding.
>
> "Learn deeply, write clearly.", [NexaTutor](#deeptutor-co-writer)

### Links

[NexaTutor Co-Writer](#deeptutor-co-writer "co-writer section")

[NexaTutor Learning Note](#deeptutor-learning-note)
...
> NexaTutor brand mark used inside the co-writer template.
...
- [x] Draft a NexaTutor product note
...
op=>operation: NexaTutor analyzes intent
...
${FENCE}seq
Student->NexaTutor: Ask for help
NexaTutor->KnowledgeBase: Load context
Note right of NexaTutor: Collect memory\\nand relevant knowledge
NexaTutor-->Student: Return guided response
Student->>NexaTutor: Request rewrite in co-writer
${FENCE}
