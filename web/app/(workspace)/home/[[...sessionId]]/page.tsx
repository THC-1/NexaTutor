...
export default function ChatPage() {
  ...
  // How many times NexaTutor may consult the selected agent this turn. Seeded
  ...
  const handleSend = useCallback(
    async (content: string) => {
      ...
      // (how many times NexaTutor may ask it) so the subagent capability uses it.
...
function SubagentTabWatcher({
  ...
  useEffect(() => {
    // Group by turn so all of one turn's consults (NexaTutor may ask the agent
