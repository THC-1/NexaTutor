...
/** "NexaTutor_Introduction.pdf" → "NexaTutor Introduction" — the card title
  ...
  return (
    <>
      {/* Activity block pinned to the TOP: the status header
          ("NexaTutor Exploring… · 8s" → "NexaTutor responded. · 10s") with
          the exploring trace nested beneath it — expanded while NexaTutor is
