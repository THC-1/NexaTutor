...
makes that contract explicit for the standard LlamaIndex pipeline. It is
intentionally minimal: ``RAGService`` still probes for optional methods with
``hasattr`` to stay tolerant of partial implementations.
"""
