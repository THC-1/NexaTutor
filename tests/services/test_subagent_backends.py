...
# ---- registry: local CLI backends remain --------------------------------------


def test_registry_excludes_partner_and_preserves_local_cli_backends() -> None:
    from deeptutor.services.subagent import get_backend, list_backend_kinds

    assert "partner" not in list_backend_kinds()
    assert get_backend("partner") is None
